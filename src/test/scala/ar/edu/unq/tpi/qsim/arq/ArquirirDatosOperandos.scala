...
class ArquirirDatosOperandos extends FlatSpec with Matchers {
  ...
  def simuladores = new {
    ...
    simulador1.inicializarSim(mapFlags)
    ...
    simulador2.inicializarSim(mapFlags)
    ...
    simulador3.inicializarSim(mapFlags)
    ...
    simulador4.inicializarSim(mapFlags)
    ...
    simulador5.inicializarSim(mapFlags)
    ...
    simulador6.inicializarSim(mapFlags)
    ...
    simulador7.inicializarSim(mapFlags)
    ...
    simulador8.inicializarSim(mapFlags)
